...
public class CapNhatSanPhamForm extends JPanel {
	...
	private  JButton btnThemAnhSach;
	...
	public CapNhatSanPhamForm() {
		...
		gl_panelVPP.setHorizontalGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING).addGroup(gl_panelVPP
				...
				.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelVPP.createSequentialGroup().addGap(10)
								...
								.addGap(10).addComponent(txtTimKiemVPP, GroupLayout.PREFERRED_SIZE, 156,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panelVPP.createSequentialGroup().addGap(10)
								.addComponent(scrVPP, GroupLayout.PREFERRED_SIZE, 678, GroupLayout.PREFERRED_SIZE)
								.addGap(65)
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelVPP.createSequentialGroup().addGap(15).addComponent(
												lblHinhAnhSP, GroupLayout.PREFERRED_SIZE, 250,
												GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_panelVPP.createSequentialGroup()
												.addComponent(lblTenSP, GroupLayout.PREFERRED_SIZE, 93,
														GroupLayout.PREFERRED_SIZE)
												.addGap(40).addComponent(lblNewLabel_3_1, GroupLayout.PREFERRED_SIZE,
														144, GroupLayout.PREFERRED_SIZE))))
						.addGroup(gl_panelVPP.createSequentialGroup().addGap(33).addGroup(gl_panelVPP
								...
								.addGap(10)
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addComponent(txtMaSanPham, GroupLayout.PREFERRED_SIZE, 174,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtLoai, GroupLayout.PREFERRED_SIZE, 174,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txSoLuongVPP, GroupLayout.PREFERRED_SIZE, 174,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(cmbNCCVPP, GroupLayout.PREFERRED_SIZE, 174,
												GroupLayout.PREFERRED_SIZE))
								.addGap(76)
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelVPP.createSequentialGroup()
												.addComponent(lblMoTaSP, GroupLayout.PREFERRED_SIZE, 87,
														GroupLayout.PREFERRED_SIZE)
												.addGap(14)
												.addComponent(txaMoTaSP, GroupLayout.PREFERRED_SIZE, 177,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(btnThemSP, GroupLayout.PREFERRED_SIZE, 101,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(btnCapNhapSP, GroupLayout.DEFAULT_SIZE, 157,
														Short.MAX_VALUE)
												.addGap(14)
												.addComponent(btnLamMoiSP, GroupLayout.PREFERRED_SIZE, 114,
														GroupLayout.PREFERRED_SIZE)
												.addGap(12))
										.addGroup(gl_panelVPP.createSequentialGroup()
												.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_panelVPP.createSequentialGroup()
																.addComponent(lblGiaNhapSP, GroupLayout.PREFERRED_SIZE,
																		87, GroupLayout.PREFERRED_SIZE)
																.addGap(17).addComponent(txtGiaNhapSP,
																		GroupLayout.PREFERRED_SIZE, 174,
																		GroupLayout.PREFERRED_SIZE))
														.addGroup(gl_panelVPP.createSequentialGroup()
																.addComponent(lblGiaBanSP, GroupLayout.PREFERRED_SIZE,
																		87, GroupLayout.PREFERRED_SIZE)
																.addGap(17).addComponent(txtGiaBanSP,
																		GroupLayout.PREFERRED_SIZE, 174,
																		GroupLayout.PREFERRED_SIZE)))
		...
		gl_panelVPP.setVerticalGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelVPP.createSequentialGroup().addGap(11)
						.addGroup(gl_panelVPP
								.createParallelGroup(Alignment.LEADING)
								.addComponent(lblTimKiemVPP, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
								.addComponent(txtTimKiemVPP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(6)
						.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
								.addGroup(
										gl_panelVPP.createSequentialGroup().addGap(17).addComponent(scrVPP,
												GroupLayout.PREFERRED_SIZE, 287, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panelVPP.createSequentialGroup()
										.addComponent(lblHinhAnhSP, GroupLayout.PREFERRED_SIZE, 256,
												GroupLayout.PREFERRED_SIZE)
										.addGap(44)
										.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
												.addComponent(lblTenSP)
												.addComponent(lblNewLabel_3_1, GroupLayout.PREFERRED_SIZE, 14,
														GroupLayout.PREFERRED_SIZE))))
						.addGap(11)
						.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING).addGroup(gl_panelVPP
								.createSequentialGroup()
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addComponent(lblMaSP, GroupLayout.PREFERRED_SIZE, 20,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblGiaNhapSP, GroupLayout.PREFERRED_SIZE, 20,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtGiaNhapSP, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addGap(23)
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addComponent(lblLoai, GroupLayout.PREFERRED_SIZE, 20,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblGiaBanSP, GroupLayout.PREFERRED_SIZE, 20,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtGiaBanSP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelVPP.createSequentialGroup().addGap(8)
												.addGroup(gl_panelVPP.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_panelVPP.createSequentialGroup().addGap(23)
																.addComponent(lblSoLuongVPP, GroupLayout.PREFERRED_SIZE,
																		20, GroupLayout.PREFERRED_SIZE)
																.addGap(34)
																.addComponent(lblNCCVPP, GroupLayout.PREFERRED_SIZE, 20,
																		GroupLayout.PREFERRED_SIZE))
														.addGroup(gl_panelVPP.createSequentialGroup().addGap(23)
																.addComponent(lblMoTaSP, GroupLayout.PREFERRED_SIZE, 20,
																		GroupLayout.PREFERRED_SIZE))
														.addGroup(gl_panelVPP.createSequentialGroup().addGap(21)
																.addComponent(txaMoTaSP, GroupLayout.PREFERRED_SIZE, 81,
																		GroupLayout.PREFERRED_SIZE))))
										.addGroup(gl_panelVPP.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addGroup(gl_panelVPP.createParallelGroup(Alignment.BASELINE)
														.addComponent(btnThemSP, GroupLayout.PREFERRED_SIZE, 33,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(btnLamMoiSP, GroupLayout.PREFERRED_SIZE, 37,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(btnCapNhapSP, GroupLayout.PREFERRED_SIZE, 33,
																GroupLayout.PREFERRED_SIZE)))))
								.addGroup(gl_panelVPP.createSequentialGroup()
		...
		btnThemAnhSach = new JButton("Thêm Ảnh");
		...
		gl_panelSach.setHorizontalGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panelSach.createSequentialGroup().addGap(12)
						...
						.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING).addGroup(gl_panelSach
								...
								.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelSach.createSequentialGroup().addGap(17)
												.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
														.addComponent(lblTacGia, GroupLayout.PREFERRED_SIZE, 87,
																GroupLayout.PREFERRED_SIZE)
														.addGroup(gl_panelSach.createSequentialGroup()
																...
																.addPreferredGap(ComponentPlacement.RELATED)
																.addComponent(lbTenSach_1, GroupLayout.PREFERRED_SIZE,
																		144, GroupLayout.PREFERRED_SIZE))))
										.addGroup(gl_panelSach.createSequentialGroup().addGap(150).addComponent(
												btnThemAnhSach, GroupLayout.PREFERRED_SIZE, 98,
												GroupLayout.PREFERRED_SIZE))))
								.addGroup(Alignment.TRAILING,
										gl_panelSach.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.RELATED, 98, Short.MAX_VALUE)
												.addComponent(lblHinhAnhSach, GroupLayout.PREFERRED_SIZE, 213,
														GroupLayout.PREFERRED_SIZE)
												.addGap(69))))
										...
										.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(gl_panelSach.createSequentialGroup()
														...
														.addComponent(txaMoTaSach, GroupLayout.PREFERRED_SIZE, 177,
																GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_panelSach
												.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_panelSach.createSequentialGroup().addGap(175).addComponent(
														txtTacGia, GroupLayout.PREFERRED_SIZE, 174,
														GroupLayout.PREFERRED_SIZE))
												.addGroup(gl_panelSach.createSequentialGroup().addGap(18)
														.addComponent(btnThemSach, GroupLayout.PREFERRED_SIZE, 107,
																GroupLayout.PREFERRED_SIZE)
														.addGap(18)
														.addComponent(btnCapNhatSach, GroupLayout.PREFERRED_SIZE, 132,
																GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(ComponentPlacement.UNRELATED)
		...
		gl_panelSach.setVerticalGroup(gl_panelSach.createParallelGroup(Alignment.LEADING).addGroup(gl_panelSach
				...
				.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelSach.createSequentialGroup().addGap(30).addComponent(scrSach,
								GroupLayout.PREFERRED_SIZE, 287, GroupLayout.PREFERRED_SIZE))
						.addGroup(
								gl_panelSach.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(lblHinhAnhSach, GroupLayout.PREFERRED_SIZE, 245,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addComponent(btnThemAnhSach, GroupLayout.PREFERRED_SIZE, 29,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
												.addComponent(lblNewLabel_2)
												.addComponent(lbTenSach_1, GroupLayout.PREFERRED_SIZE, 14,
														GroupLayout.PREFERRED_SIZE))))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING).addGroup(gl_panelSach
						.createSequentialGroup().addGap(8)
						.addGroup(gl_panelSach.createParallelGroup(Alignment.BASELINE)
								.addComponent(txtTacGia, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panelSach.createSequentialGroup().addGap(1)
										.addGroup(gl_panelSach.createParallelGroup(Alignment.BASELINE)
												.addComponent(btnCapNhatSach, GroupLayout.PREFERRED_SIZE, 35,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(btnLamMoi, GroupLayout.PREFERRED_SIZE, 35,
														GroupLayout.PREFERRED_SIZE)))))
						.addGroup(gl_panelSach.createSequentialGroup().addGap(18)
								.addGroup(gl_panelSach.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelSach.createSequentialGroup()
